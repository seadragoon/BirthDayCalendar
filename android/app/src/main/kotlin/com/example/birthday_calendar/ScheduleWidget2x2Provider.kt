...
class ScheduleWidget2x2Provider : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            val views = RemoteViews(context.packageName, R.layout.widget_schedule_2x2).apply {
                        ...
                        if (jsonArray.length() == 0) {
                            ...
                            for (i in 0 until 2) {
                                if (i < jsonArray.length()) {
                                    ...
                                    if (i == 1) {
                                        setViewVisibility(R.id.schedule_divider1, View.VISIBLE)
                                    }
                                } else {
                                    setViewVisibility(containers[i], View.GONE)
                                    if (i == 1) {
                                        setViewVisibility(R.id.schedule_divider1, View.GONE)
                                    }
                                }
                            }
                        }
